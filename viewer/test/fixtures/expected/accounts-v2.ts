...
const userSignedUp: Message = {
  ...
  payload: {
    ...
    constraints: [],
    children: [
      { kind: 'node', name: 'userId', path: [], types: ['string'], required: true, constraints: [], children: [] },
      { kind: 'node', name: 'email', path: [], types: ['string'], format: 'email', required: true, constraints: [], children: [] },
      { kind: 'node', name: 'displayName', path: [], types: ['string'], required: false, constraints: [], children: [] },
      {
        kind: 'node',
        name: 'createdAt',
        path: [],
...
const loginFailed: Message = {
  ...
  payload: {
    ...
    children: [
      ...
      { kind: 'node', name: 'ip', path: [], types: ['string'], required: false, constraints: [], children: [] },
    ],
  },
  examples: [],
  tags: [],
